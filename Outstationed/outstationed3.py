...
pd = pandas.read_csv('../Copy of Bwari Group 25-11-23 - Sheet1.csv')
...
for n in range(len(login_dict)):
    ...
    for num in range(3):
        ...
        if num == 0:
            ...
            new_attendance = choice(list(range(10, 16)))
            new_first_timers = choice(list(range(3, 6)))
            new_new_converts = choice(list(range(1, 4)))
            new_holy_spirit = choice(list(range(1, 3)))
            new_midweek = choice(list(range(3, 9)))
            new_church = choice(list(range(10, 16)))
        ...
        # --------Bible Study 1------------------
            ...
            new_attendance = choice(list(range(11, 16)))
            new_first_timers = choice(list(range(3, 7)))
            new_new_converts = choice(list(range(1, 4)))
            new_holy_spirit = choice(list(range(1, 3)))
            new_midweek = choice(list(range(4, 8)))
            new_church = choice(list(range(9, 17)))
        ...
        # --------Bible Study 2------------------
            ...
            new_attendance = choice(list(range(11, 16)))
            new_first_timers = choice(list(range(3, 7)))
            new_new_converts = choice(list(range(2, 4)))
            new_holy_spirit = choice(list(range(1, 3)))
            new_midweek = choice(list(range(5, 9)))
            new_church = choice(list(range(10, 17)))
